...
class A {
    public A (){
        System.out.println("object already created"); // here we have already created an object  and no we are creating the constructor
    }
...
public class Anonymousobjects {
    public static void main(String[] args) {
        ...
        A a = new A();// here the small a is referring to a refernce value that is used to reference the object being created
        a.show();
